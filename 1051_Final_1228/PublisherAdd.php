...
{	 
	 $sql_query = "INSERT INTO publisher (publisher_name, publisher_address, publisher_phone) VALUES (";
	...
	<div class="row content">
		...
		<!-- ======================================================================================================================================================= -->
						...
						<table  border="1" class="table table-hover" style="border:4px lightskyblue solid; width:50%;" rules="all">
							...
							<tbody>
							<tr>
							  <td><input type="text" id="publisher_name" name="publisher_name" value=""/></td> 
							  <td><input type="text" id="publisher_address" name="publisher_address" value=""/></td> 
							  <td><input type="text" id="publisher_phone" name="publisher_phone" value=""/></td> 
